<h1>Translation - HTML Template</h1>

<h2>How to use Translation</h2>

<ol>
	<li><a href="https://github.com/ROXy10/translation_full/archive/master.zip">Download</a> <strong>template</strong> from GitHub;</li>
